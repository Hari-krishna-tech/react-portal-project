...
const DatabaseSetting = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:10000/database-settings/",
        validatedData
      );
  ...
  return (
    <div className="database-setting-container">
      {showSuccessModal && (
        <div className="success-modal">Settings saved successfully!</div>
      )}
      <div className="database-setting-form">
        ...
        >
          <h1 className="form-title">Database Setting</h1>
          <Link
            to="/settings/database-settings/list"
