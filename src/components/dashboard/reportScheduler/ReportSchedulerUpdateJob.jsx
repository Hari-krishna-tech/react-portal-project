...
const UpdateJob = ({ jobId }) => {
  ...
  useEffect(() => {
    ...
    // Fetch job data
    axios
      .get(`http://localhost:10000/api/jobs/${jobId}`)
      .then((res) => {
        ...
        setFormData({
          ...
          updatedAt: getLocalDateTime(),
          updatedBy: user,
          keyUserEmail: jobData.keyUserEmail.reduce(
            (acc, key) => acc + ";" + key
          ),
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(`http://localhost:10000/api/jobs/${jobId}`, result.data)
      .then((res) => {
    ...
    <>
      <div className="create-job-container">
        <div className="create-job-form">
          <h1 className="form-title"> Update Job</h1>
